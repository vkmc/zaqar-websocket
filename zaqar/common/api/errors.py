...
class ServiceUnavailable(ExceptionBase):
    """Raised when the service cannot be reached"""

    msg_format = u'Service unavailable. {description}'
    ...
    def __init__(self, description):
        ...
        super(ServiceUnavailable, self).__init__(description=description)
...
class BadRequestBody(BadRequest):
    ...
    def __init__(self, description):
        ...
        super(BadRequestBody, self).__init__(description=description)